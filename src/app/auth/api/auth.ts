...
import { LoginUserParams, PlayerAuthResponse, GetLobbyData, LobbyResponse } from '@utils/types/index';
...
export const AuthApiModule = {
   ...
   */
	...
	getLobbyById: (params: GetLobbyData): Promise<AxiosResponse<LobbyResponse>> => {
		return api.post('/lobby/get-by-id', params);
	},
};
